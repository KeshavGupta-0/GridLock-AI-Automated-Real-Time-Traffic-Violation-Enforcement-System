"""
Training Script — Seatbelt Non-Compliance Detection (YOLOv8n)
...
Note: If the hosted Roboflow API for seatbelt detection works well
enough for your demo, you may skip training entirely. The Streamlit
app will automatically fall back to the API if no local weights exist.
"""
...
BATCH_SIZE = 16
PATIENCE = 10
MODEL_BASE = "yolov8n.pt"  # Nano model

# Output directory
OUTPUT_DIR = Path("models/seatbelt_model")


def main():
    print("=" * 60)
    print("  Seatbelt Detection — YOLOv8n Fine-Tuning")
    print("=" * 60)
    ...
    print("  models/seatbelt_model/weights/best.pt")
    print("=" * 60)
